...
## Welcome to the MixUpOS on-line help system!

This is **Help**, the built-in documentation viewer for the MixUpOS desktop environment. If you prefer a command-line interface, the [`man`(1)](help://man/1/man) command offers a text-only view of the same library.
...
Thank you for using **_MixUpOS Help!_**
