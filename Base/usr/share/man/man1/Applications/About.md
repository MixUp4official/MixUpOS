...
![Icon](/res/icons/16x16/ladyball.png) About - About MixUpOS
...
`About` is an application that displays information about MixUpOS.
MixUpOS is based on SerenityOS and retains the upstream project's visual and technical heritage.
...
To learn more about the upstream SerenityOS project visit the [homepage](https://serenityos.org).
