...
static Array const s_registered_mime_type = {
    MimeType { .name = "application/dicom"sv, .common_extensions = { ".dic"sv, ".dicom"sv }, .description = "DICOM medical image data"sv, .magic_bytes = Vector<u8> { 'D', 'I', 'C', 'M' }, .offset = 128 },
    MimeType { .name = "application/vnd.android.package-archive"sv, .common_extensions = { ".apk"sv }, .description = "Android application package"sv },
    MimeType { .name = "application/vnd.apple.installer-package"sv, .common_extensions = { ".pkg"sv }, .description = "Apple installer package"sv },
    MimeType { .name = "application/vnd.ms-appx"sv, .common_extensions = { ".appx"sv, ".msix"sv }, .description = "Windows app package"sv },
    MimeType { .name = "application/x-mixupos-app"sv, .common_extensions = { ".mixapp"sv }, .description = "MixUpOS portable application"sv },
    ...
    MimeType { .name = "application/java-archive"sv, .common_extensions = { ".jar"sv, ".war"sv }, .description = "Java archive"sv },
    ...
    MimeType { .name = "application/x-debian-package"sv, .common_extensions = { ".deb"sv }, .description = "Debian binary package"sv, .magic_bytes = Vector<u8> { '!', '<', 'a', 'r', 'c', 'h', '>', '\n' } },
    MimeType { .name = "application/x-apple-diskimage"sv, .common_extensions = { ".dmg"sv }, .description = "Apple disk image"sv },
    MimeType { .name = "application/x-executable"sv, .common_extensions = { ".exe"sv, ".dll"sv }, .description = "Windows executable"sv, .magic_bytes = Vector<u8> { 'M', 'Z' } },
    MimeType { .name = "application/x-ios-app"sv, .common_extensions = { ".ipa"sv }, .description = "iOS application archive"sv },
    MimeType { .name = "application/x-mach-binary"sv, .common_extensions = { ".dylib"sv }, .description = "Mach-O binary"sv },
    MimeType { .name = "application/x-msi"sv, .common_extensions = { ".msi"sv }, .description = "Windows installer package"sv },
    MimeType { .name = "application/x-rpm"sv, .common_extensions = { ".rpm"sv }, .description = "RPM package"sv, .magic_bytes = Vector<u8> { 0xED, 0xAB, 0xEE, 0xDB } },
    MimeType { .name = "application/x-xz"sv, .common_extensions = { ".xz"sv }, .description = "XZ compressed data"sv, .magic_bytes = Vector<u8> { 0xFD, 0x37, 0x7A, 0x58, 0x5A, 0x00 } },
    ...
    MimeType { .name = "application/zip"sv, .common_extensions = { ".zip"sv, ".aar"sv, ".appx"sv, ".cbz"sv, ".epub"sv, ".jar"sv, ".msix"sv, ".whl"sv, ".xpi"sv }, .description = "ZIP archive"sv, .magic_bytes = Vector<u8> { 0x50, 0x4B } },
