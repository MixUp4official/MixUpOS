...
ErrorOr<void> TaskbarWidget::create_context_menu()
{
    ...
    m_context_menu->add_action(*open_browser_action);
    m_context_menu->add_action(*open_files_action);
    m_context_menu->add_action(*open_terminal_action);
    m_context_menu->add_action(*open_app_store_action);
    m_context_menu->add_action(*open_recovery_center_action);
