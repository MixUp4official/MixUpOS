# Setting up a MixUpOS development environment on Windows

MixUpOS can be built and run under WSL Version 2.
...
Next, go to [BuildInstructions.md](BuildInstructions.md)
...
Run `bash Meta/mixupos.sh run` to build and run MixUpOS as usual.
...
Afterwards you can start the VM with `bash Meta/mixupos.sh run` as usual.
